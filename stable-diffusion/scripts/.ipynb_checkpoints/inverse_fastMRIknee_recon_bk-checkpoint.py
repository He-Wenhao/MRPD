...
parser.add_argument(
    "--ckpt",
    type=str,
    default='../../stable-diffusion/models/first_stage_models/vq-f4/model.ckpt',
...
def plot_img(image_tensor,name):
    ...
    plt.title("Random 3-Channel Image (320x320)")
    plt.axis('off')
    plt.savefig(name)
...
for img in test_dataloader:
    ...
    plt.subplot(1, 2, 2)
    plt.imshow(pred_img)
    plt.title(f'Reconstructed\nPSNR: {psnr_recon:.2f}, SSIM: {ssim_recon:.4f}, MSE: {mse_recon:.4f}')
    plt.axis('off')
